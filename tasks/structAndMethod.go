...
func (person Person) GetInfo() string {
	return "Name: " + person.Name + ", Age: " + fmt.Sprint(person.Age) + ", City: " + person.City
}


// Commented out function TestAddMethodToStruct in /tests/structAndMethod.go to test the Task 2
